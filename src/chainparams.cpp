...
public:
    CMainParams() {
        ...
        consensus.MENAColdStakeEnableHeight = 1;
        ...
        consensus.authorityID = CKeyID(uint160(ParseHex("546732f5c0e9d239d3aea0a43bf5e3f59bd06831"))); // Mainnet publisher id
...
public:
    CTestNetParams() {
        ...
        consensus.nMinerConfirmationWindow = 2016; // nTargetTimespan / nTargetSpacing
        consensus.MinBIP9WarningHeight = consensus.SegwitHeight + consensus.nMinerConfirmationWindow;
        consensus.MENAColdStakeEnableHeight = 2000;
