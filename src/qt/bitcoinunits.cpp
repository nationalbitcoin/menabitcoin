...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MENA);
    unitlist.append(mMENA);
    unitlist.append(uMENA);
    unitlist.append(SAT);
    return unitlist;
}
...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case MENA: return QString("MENA");
    case mMENA: return QString("mMENA");
    case uMENA: return QString::fromUtf8("µMENA (bits)");
...
QString BitcoinUnits::shortName(int unit)
{
    switch(unit)
    {
    case uMENA: return QString::fromUtf8("bits");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MENA: return QString("MENA Bitcoins");
    case mMENA: return QString("Milli-MENAs (1 / 1" THIN_SP_UTF8 "000)");
    case uMENA: return QString("Micro-MENAs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MENA: return 100000000;
    case mMENA: return 100000;
    case uMENA: return 100;
    case SAT: return 1;
