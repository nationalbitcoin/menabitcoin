...
const char * const BITCOIN_CONF_FILENAME = "menabitcoin.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\menabitcoin
    // macOS: ~/Library/Application Support/MENABitcoin
    // Unix-like: ~/.menabitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MENABitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/MENABitcoin";
#else
    // Unix-like
    return pathRet / ".menabitcoin";
#endif
#endif
}
