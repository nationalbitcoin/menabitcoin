...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //MENATODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeMENAs(bool fStake, CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool)
{
    ::StakeMENAs(fStake, this, connman, chainman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman* connman, ChainstateManager* chainman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeMENAs(true, connman, chainman, mempool);
}
