...
bool MemPoolAccept::PreChecks(ATMPArgs& args, Workspace& ws)
{
    ...
    bool fColdStakingActive = ::ChainActive().Height() >= Params().GetConsensus().MENAColdStakeEnableHeight;
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    // Minimal block reward is 0.01 MENA
...
bool CheckBlock(const CBlock& block, BlockValidationState& state, const Consensus::Params& consensusParams, bool fCheckPoA, bool fCheckMerkleRoot, bool fCheckSig)
{
    ...
    bool fColdStakingActive = ::ChainActive().Height() >= consensusParams.MENAColdStakeEnableHeight;
